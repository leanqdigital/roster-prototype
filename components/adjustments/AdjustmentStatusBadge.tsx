...
import type { ShiftAdjustmentStatus } from "@/lib/company-data";

const STYLES: Record<ShiftAdjustmentStatus, string> = {
...
const DOTS: Record<ShiftAdjustmentStatus, string> = {
...
export default function AdjustmentStatusBadge({
  status,
}: {
