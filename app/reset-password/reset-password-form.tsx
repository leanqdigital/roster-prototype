...
// User lands here already authenticated — app/auth/confirm/confirm-form.tsx
// verifies the recovery OTP token and hard-navigates here so the session is
      ...
      <div className="w-full max-w-sm">
        ...
        {ready && !user ? (
          <div className="mt-6 rounded-xl border border-hairline bg-surface-2 p-6 text-center text-[13px] text-ink-muted">
            Ask for a new reset link, then open it again.
          </div>
        ) : (
          <form
